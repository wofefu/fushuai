...
@ComponentScan(basePackages = {"com.fuhsuai.service.impl", "com.fuhsuai.aspect"})//spring扫包
@MapperScan(basePackages = {"com.fuhsuai.dao"})
...
public class SpringConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.exam.sms.entity");
